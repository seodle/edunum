...
ui <- dashboardPage(
  ...
  dashboardSidebar(width = 200,
                   sidebarMenu(id = "sidebarid",
                               ...
                               menuItem(HTML("Codage des facilitateurs <br> et obstacles"), tabName = "page2"),
                               conditionalPanel(
                                 'input.sidebarid == "page2"'),
                               
                               menuItem("Visualisation des résultats", tabName = "page3"),
                               conditionalPanel(
...
server <- function(input, output) {
  ...
  output$table_text <- renderTable({
    ...
    data.frame(Questions = c("Avant l'enseignement", "Pendant l'enseignement"), Réponses = c(text1,text2))
  })
  ...
  ###############################################################
  #CODAGE DES FACILITATEURS/OBSTACLES
  ###############################################################
