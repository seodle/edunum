...
data <- read.csv("data_evaluation.csv",header = TRUE, na.strings=c("","NA"), check.names = FALSE, sep = ";")
...
data$links <-  paste0("<a href=","'",data$url_details,"'",">",data$x_axis,"</a>")
...
user_base <- dplyr::tibble(
  user = c("edunum"),
  password = sapply(c("pv7yes8gtdgt"), sodium::password_store), 
...
ui <- dashboardPage(title="Pilotage de la formation EduNum",
  ...
  dashboardBody(
    ...
    tags$head(tags$style(HTML('.content-wrapper { height: 4550px !important;}'))),
    
    fluidRow(
    
    tabItems(
      
      tabItem(tabName = "page2",style='padding:10px',
              ...
              br(), br(),
              HTML("<h4>Ce tableau de bord est sous licence MIT. Pour tout renseignement : Dr. Sunny Avry – sunny.avry@epfl.ch</h4>"),
              br(),
    ...
    fluidRow(id = "row0",style='padding:10px',
      tabBox(title = HTML("<b>Variables enseignant.e.s</b>"),
             ...
             tabPanel("Motivation prélable",
                      ...
                      HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>Je me sens motivé pour participer à cette formation.</i></h5>")),
             tabPanel("Attitude envers l'éducation numérique",
                      ...
                      HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>Je trouve que la réforme de l'éducation numérique est une bonne chose.</i></h5>")),
      )),
              
    
    fluidRow(id = "row1",style='padding:10px',
    tabBox(title = HTML("<b>Variables formation</b>"),
      ...
      tabPanel("Implication/Appréciation",
               ...
               HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai trouvé l'équipe de formation impliquée lors de cette journée</i> ou <i>J'ai apprécié l'équipe de formation lors de cette journée.</i></h5>")),
      tabPanel("Qualité perçue des méthodes pédagogiques employées",
               ...
               HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>La façon dont a été présenté le contenu était adaptée.</i></h5>")),
    )),
  
    fluidRow(id = "row2",style='padding:10px',
      tabBox(title = HTML("<b style='color:#ffd500;'>Niveau 1 (Réactions immédiates)</b>"),
        id = "tabset2", height = "600px", width=12,
        tabPanel("Intérêt perçu pour les ressources",
                 ...
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai trouvé cette ressource intéressante</i> ")),
        tabPanel("Utilité perçue des ressources",
                 ...
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai trouvé cette ressource utile pour mon enseignant</i>")),
        tabPanel("Facilité perçue d'utilisation", 
                 ...
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai trouvé cette ressource facile à intégrer dans ma pratique enseignante</i> ")),
        tabPanel("Auto-efficacité vis-à-vis des ressources", 
                 ...
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>Je me sens capable d'intégrer cette ressource dans mon enseignement</i> ")),
        tabPanel("Intention d'utiliser les ressources", 
                 ...
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai l'intention d'intégrer cette ressource dans mon enseignement</i> "))
      )),
  
    fluidRow(id = "row3",style='padding:10px',
      tabBox(
        title = HTML("<b style='color:#6DA845;'>Niveau 2 (Acquisition des connaissances et compétences numériques)</b>"),
        # The id lets us use input$tabset1 on the server to find the current tab
        id = "tabset3", height = "650px", width=12,
        tabPanel("Acquisition des contenus théoriques", 
                 ...
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout acquis) et 7 (Tout à fait acquis) converti en pourcentage (0% - 100%) à des questions telles que <i>Est-ce que cette notion théorique est maintenant acquise pour vous?</i> ")),
        tabPanel("Acquisition des compétences numériques (cf. RCnum)",
                 ...
                 br(),
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout acquis) et 7 (Tout à fait acquis) converti en pourcentage (0% - 100%) à des questions telles que <i>Est-ce que cette compétence est maintenant acquise pour vous?</i> "))
        
      )),
    
    fluidRow(id = "row4",style='padding:10px',
      tabBox(
        title = HTML("<b style='color:#5A9AD3;'>Niveau 3 (Conditions facilitantes/entravantes et efficience perçue des ressources de formation)</b>"),
        # The id lets us use input$tabset1 on the server to find the current tab
        ...
        tabPanel("Ressources matérielles",
                 ...
                 HTML("<h5>Le score peut représenter : <br><br> 1) le score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai le matériel nécessaire pour intégrer les ressources de formation dans ma pratique</i> <br>
                                                       2) le pourcentage de participants ne rapportant pas les ressources matérielles parmi les différentes conditions entravantes proposées")),
        tabPanel("Ressources temporelles",
                 HTML("<h5>Le score reflète la perception des ressources temporelles rapporté par les participants pour l'utilisation des ressources de formation.</h5>"),
                 plotlyOutput("niveau3_temporel"),
                 HTML("<h5>Le score peut représenter : <br><br> 1) le score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai le temps nécessaire pour intégrer les ressources de formation dans ma pratique</i> <br>
                                                       2) le pourcentage de participants ne rapportant pas les ressources temporelles parmi les différentes conditions entravantes proposées")),
        tabPanel("Soutien de la hiérarchie et des collègues", 
                 ...
                 HTML("<h5>Le score peut représenter : <br><br> 1) le score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai le soutien de ma hiérarchie ou des mes collègues pour intégrer les ressources de formation dans ma pratique</i> <br>
                                                       2) le pourcentage de participants ne rapportant pas le soutien de la hiérarchie ou des collègues parmi les différentes conditions entravantes proposées")),
        tabPanel("Soutien technique et pédagogique", 
                 ...
                 HTML("<h5>Le score peut représenter : <br><br> 1) le score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>J'ai le soutien technique ou pédagogique pour intégrer les ressources de formation dans ma pratique</i> <br>
                                                       2) le pourcentage de participants ne rapportant pas le soutien technique et/ou pédagogique parmi les différentes conditions entravantes proposées")),
        tabPanel("Compatibilité avec les pratiques habituelles",
                 ...
                 HTML("<h5>Le score peut représenter : <br><br> 1) le score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des affirmations telles que <i>Les ressources proposées s'intègrent à mes pratiques habituelles d'enseignement</i> <br>
                                                       2) le pourcentage de participants ne rapportant pas la compatibilité avec les pratiques habituelles d'enseignement parmi les différentes conditions entravantes proposées")),
        tabPanel("Efficience perçue des ressources",
    ...
    fluidRow(id = "row5",style='padding:10px',
      tabBox(
        title =  HTML("<b style='color:#ED7D31;'>Niveau 4 (Mise en oeuvre des ressources et transfert des compétences numériques)</b>"),
        # The id lets us use input$tabset1 on the server to find the current tab
        id = "tabset5", height = "700px", width=12,
        tabPanel("Mise en oeuvre en classe d'activités liées aux ressources de formation", 
                 HTML("<h5>Le score reflète la réalisation d'activités en classe à partir des ressources de formation proposées.</h5>"),
                 plotlyOutput("niveau4_utilisation"),
                 br(),
                 HTML("<h5>Pourcentage de particpants ayant mis (ou rapportant avoir mis) en oeuvre au moins une fois des activités vues en formation ou basée sur les ressources de formation.</h5>")),
        tabPanel("Transfert en classe des compétences numériques (RCnum) associées aux ressources de formation",
                 ...
                 br(),
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout acquis) et 7 (Tout à fait acquis) converti en pourcentage (0% - 100%) à des questions telles que <i>Est-ce que cette compétence  numérique  a été mise en oeuvre en classe?</i></h5>")),
      )),
    
    fluidRow(id = "row6",style='padding:10px',
      tabBox(
    ...
    fluidRow(id ="row7",style='padding:10px',
      tabBox(
        title = HTML("<b style='color:#A5A5A5;'>Niveau 5 (Résultats élèves)</b>"),
        id = "tabset7", height = "300px", width=12,
        tabPanel("Compétences disciplinaires (PERnum) : Perception des enseignants",
                 HTML("<h5>Le score reflète à quel point les enseignants ont mobilisés chez les élèves les compétences numériques displinaires associées aux ressources de formation proposées.<br><br></h5>"),
                 plotlyOutput("niveau5_pernum"),
                 HTML("<h5>Score moyen sur une échelle de Likert entre 1 (Pas du tout d'accord) et 7 (Tout à fait d'accord) converti en pourcentage (0% - 100%) à des questions telles que <i>J'ai fait découvrir cette compétence numérique à mes élèves</i> ")),
        tabPanel("Compétences disciplinaires (PERnum) : Tests", ""),
...
server <- function(input, output, session) {
  ...
  output$formation_implication <- renderPlotly({ 
      ...
      data$links <- factor(data$links, unique(data$links))
  ...
  output$niveau3_materiel <- renderPlotly({ 
    ...
    data <- data %>% filter(cycle_formation == input$var1, phase == input$var2, participants == input$var3, critere == "Ressources matérielles")
    data$links <- factor(data$links, unique(data$links))
    
    data <- data %>% mutate(grade = case_when(
      score < 25  ~ "Faible" ,
      score >= 26  & score < 50 ~ "Moyen"  ,
      score >= 51  & score < 75  ~ "Bon"  ,
      score >= 75 ~ "Excellent"))
  ...
  output$niveau3_temporel <- renderPlotly({ 
    ...
    data <- data %>% filter(cycle_formation == input$var1, phase == input$var2, participants == input$var3, critere == "Ressources temporelles")
    data$links <- factor(data$links, unique(data$links))
  ...
  output$niveau3_hierarchie <- renderPlotly({ 
    ...
    data <- data %>% filter(cycle_formation == input$var1, phase == input$var2, participants == input$var3, critere == "Soutien hiérarchique ou des collègues")
    data$links <- factor(data$links, unique(data$links))
  ...
  output$niveau3_techno_pedagogie <- renderPlotly({ 
    ...
    data <- data %>% filter(cycle_formation == input$var1, phase == input$var2, participants == input$var3, critere == "Soutien technique et/ou pédagogique")
    data$links <- factor(data$links, unique(data$links))
  ...
  output$niveau3_compatibilite <- renderPlotly({ 
    ...
    data <- data %>% filter(cycle_formation == input$var1, phase == input$var2, participants == input$var3, critere == "Compatibilité avec les pratiques habituelles d'enseignement")
    data$links <- factor(data$links, unique(data$links))
  ...
  output$niveau3_efficience <- renderPlotly({ 
    ...
    data <- data %>% filter(cycle_formation == input$var1, phase == input$var2, participants == input$var3, critere == "Efficience globale")
    data$links <- factor(data$links, unique(data$links))
